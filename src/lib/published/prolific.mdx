...
I learned it from my [brother](https://www.youtube.com/channel/UC1m__bDgRlraOPZ6acH_tJQ) when we were talking about Nipsey Hussle’s face tattoo a couple years ago when Nipsey passed away.

I love that word.

**Prolific**

I also love that I was deeply inspired by a face tat.
...
We talked about it, and he brought up that he didn’t really care _what_ we built, and I liked that... less pressure.

I then went off to the climbing gym to get my mind off things, and on the subway ride home, I figured it out! The goal isn’t to build something big. It’s to **create a culture of creating**. To be **✨Prolific✨**.

(Justin is already pretty damn prolific, so really it’s just me who has to get his shit together lmao.)

I’ve been wanting to develop a weekly writing habit a la [Atomic Habits](https://jamesclear.com/atomic-habits), and I got started a handful of times, but it never felt right.

But this time it does feel right. I’d like to start publishing weekly updates about the things I create / produce / build each week.
