...
The issue with writing about websockets is to do so appropriately for a non-technical audience would be very difficult, and if I'm being honest, I have zero desire to write about websockets.

I mean don't get me wrong, websockets are awesome, but I really don't want to write about them lol.
...
Anyway, we're 6 weeks into these weekly posts and now I'm wondering if there's a way I can make this both easier on myself and more intriguing for the people reading this.
