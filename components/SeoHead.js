// Mostly from https://github.com/styled-components/styled-components-website
...
export default class SeoHead extends Component {
  render() {
    const {
      title = 'AKAGI.CO',
      description = 'A platform for thoughts and self-reflection',
      image = '/logo.svg',
      children,
      canonical,
      url = '',
    ...
    return (
      <Helmet>
        ...
        <link
          rel="canonical"
          href={properCanonical /*`https://www.styled-components.com${properCanonical}`*/}
        />
